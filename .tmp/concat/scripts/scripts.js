...
angular.module('wats4000App').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/main.html',
    "<div ng-app class=\"jumbotron\" ng-controller=\"MainCtrl\"> <img src=\"/time_machine_graphic.jpg\" id=\"spiral\" alt=\"Black and white swirl graphic\"> <h1>Mary's Marvelous Time Machine</h1> <p class=\"lead\"> <div ng-init=\"location='Seattle'\"> <p> <label for=\"location\">Where are you standing? <input type=\"text\" name=\"tags\" ng-model=\"tags\"> </label> </p> <p> <button class=\"btn btn-lg btn-primary\" ng-click=\"blastoff()\">Blast Off</button> </p> <dl> <!--<dt>Currently</dt>--> <dd> <img ng-src=\"{{photos.photos.photo[0].url_q}}\"></dd> <!--<dd>{{current.weather[0].description}}</dd>\n" +
    "        <dt>Temperature</dt>\n" +
